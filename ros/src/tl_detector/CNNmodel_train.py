...
path='/home/lz714/Documents/term3/final_project/misc/'
train_data_dir = path +"classified-training-images"
validation_data_dir =  path +"classified-training-images"
...
width_shift_range = 0.0, height_shift_range=0.0, rotation_range=30)
